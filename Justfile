...
set-contracts CHAIN CONTRACT_TYPE UNIVERSAL='true':
    ...
    node contract_scripts/private/_set-contracts-config.js {{CHAIN}} {{CONTRACT_TYPE}} {{UNIVERSAL}}
...
deploy SOURCE DESTINATION:
        ...
        node contract_scripts/private/_deploy-config.js {{SOURCE}} {{DESTINATION}}
...
sanity-check:
    ...
    node contract_scripts/private/_sanity-check.js
...
update-vibc CHAIN:
  ...
  npx hardhat run contract_scripts/private/_update-vibc-address.js --network {{CHAIN}}
...
create-channel:
    ...
    node contract_scripts/private/_create-channel-config.js
...
send-packet SOURCE:
    ...
    node contract_scripts/private/_send-packet-config.js {{SOURCE}}


fun-mint SOURCE:
    echo "mint tokens..."
    node contract_scripts/mint.js {{SOURCE}}
...
send-vote-info:
    ...
    node contract_scripts/private/_send-vote-info-config.js
...
switch-client:
    ...
    npx hardhat run contract_scripts/private/_update-vibc-address.js --network optimism
    npx hardhat run contract_scripts/private/_update-vibc-address.js --network base
    node contract_scripts/private/_switch-clients.js
